...
If you are using github then a lot of this stuff can be done through their GUI. Read more about it [here](../assets/https://github.com/blog/2243-rebase-and-merge-pull-requests).
...
Use `git reflog` to undo your rebase. Running the command will show you the [reflog](../assets/https://git-scm.com/docs/git-reflog) for your local repository. For example:
