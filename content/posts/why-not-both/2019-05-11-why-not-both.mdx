...
<TweetEmbed username="winkerVSbecks" id="1101502912675627014">
  Continuing with generative grid experiments. Took one of the{' '}
  <a href="https://twitter.com/tachyons_css">@tachyons_css</a> examples, sliced
  up the different sections into components and randomly sizing them in the
  container. You can then lock items and continue regenerating the grid until
  you find an interesting layout.{' '}
