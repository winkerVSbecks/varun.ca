...
Shadows and depth of field are cool effects but they're also pretty expensive and significantly impact rendering performance. In this section, we'll look at how we can optimize the performance of our scene by using a material store.
