...
The generated HTML and CSS uses the default colour mode. When the user loads the page it renders with that default colour mode. Once the JS loads it checks to see if the user's preferred choice is different and updates the CSS to match that choice. This causes the page to flash between the two styles. Not great user experience!
