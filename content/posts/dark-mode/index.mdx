...
I'm using [Styled System](https://styled-system.com/) for components with the following structure for the colour palette. For most things such as text and surface colour I am using the neutral scale. Brand colours are used for highlights and accents.
