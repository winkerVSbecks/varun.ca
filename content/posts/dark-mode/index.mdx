...
1. Convert the colour modes from hard-coded hex values to to CSS Custom Properties.
2. Generate global CSS that change the value of these CSS Custom Properties using scoped class names, for example: `varun-ca-dark` and `varun-ca-light`
3. Inject a tiny script in your HTML to check local-storage for user's preferrence and set the appropriate class name to the body tag.
...
// The above is converted into below
{
  brand: {
