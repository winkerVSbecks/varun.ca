...
image: ../assets/hexagon.gif
date: 2015-01-05
---

<CodePen
  hash="4d0c2a06e9671ec046baf30a16d811a8"
  title="Location Services with AngularJS"
  height="600"
  defaultTab="result"
/>
...
In this example I've used [Google Maps JavaScript API v3](https://developers.google.com/maps/documentation/javascript) for all the location services required. Depending on your business and/or technical needs this might not be the best option. However, the idea remains the same and you could swap out the Google services with your preferred alternative.
