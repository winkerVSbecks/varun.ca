...
![chat-head demo](../assets/chat-head-demo.gif)
...
{: .ba .b--secondary center }
![breakdown of the drag gesture](../assets/drag.gif)
...
{: .ba .b--secondary center }
![ghost image that appears while dragging on desktop](../assets/ghost.gif)
