...
image: ../assets/triangleninja.gif
date: 2016-11-15
---
...
<img alt="chat-head demo" src="../assets/chat-head-demo.gif" />
...
<img alt="breakdown of the drag gesture" src="../assets/drag.gif" />
...
When you drag an element on desktop you end up with a _ghost_ image. This is known as the [drag image](https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/Drag_operations#dragfeedback). To get around this we can set the drag image to a fake `0px × 0px` image.

<img
  alt="ghost image that appears while dragging on desktop"
...
<CodePen
  hash="BLYOLW"
  title="React Draggable Chat Head"
  height="400"
  defaultTab="result"
/>
