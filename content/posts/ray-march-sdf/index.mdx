...
This shape is created by folding a plane onto itself using some "magic numbers" along a "magic direction." We repeat the process a few times until we achieve the desired crystal shape.
...
Checkout the [full source](https://github.com/winkerVSbecks/shader-sketches/blob/main/sketches/sdf-iridescent-crystal.js) on Github. Want to take it a step further? I've expanded this sketch to combine refraction and iridescence to make a [see through crystal](https://github.com/winkerVSbecks/shader-sketches/blob/main/sketches/refraction-iridescent.js).
