...
import StyledSystem from './diagrams';
...
<StyledSystem.SystemComponentsOverview />
...
<p style={{marginBottom: '-2rem'}}>
  <a href="https://codesandbox.io/s/v86m4zkyy0" style={{border: 0, display: 'inline-block'}}>
...
<StyledSystem.InputWithAdornment />
