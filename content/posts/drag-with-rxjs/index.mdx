...
preview: ../assets/napoleon-theorem.gif
date: 2017-08-27
---

import Drag from './diagrams';

<CodePen
  hash="yoRBMj"
  title="Curves and Handles"
  height="600"
  defaultTab="result"
/>
...
<Box as="figure" mt={0} mx={0} mb={4}>
  <Drag />
  <figcaption>
    Visualization of the drag observables. Generated using{' '}
    <a href="https://rxviz.com/">rxviz.com</a>
  </figcaption>
</Box>
...
<CodePen
  hash="RZeNRE"
  title="Drag Gesture with RxJS & Hammer – without smooth motion"
  height="400"
...
<CodePen
  hash="QMVymp"
  title="Drag Gesture with RxJS & Hammer"
  height="500"
  defaultTab="js,result"
/>
