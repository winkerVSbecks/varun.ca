...
<AsciiDiagramContainer justifyContent="space-around" flexWrap="wrap">
  <AsciiDiagram>{diagrams.gridLines}</AsciiDiagram>
  <AsciiDiagram>{diagrams.rowTracks}</AsciiDiagram>
  <AsciiDiagram>{diagrams.columnTracks}</AsciiDiagram>
...
<AsciiDiagramContainer justifyContent="center">
  <AsciiDiagram>{diagrams.gridArea}</AsciiDiagram>
  <SrOnly as="figcaption">
...
<AsciiDiagram>{diagrams.fixedGrid}</AsciiDiagram>
...
<AsciiDiagram>{diagrams.flexibleGrid}</AsciiDiagram>
...
<AsciiDiagram>{diagrams.flexibleFrGrid}</AsciiDiagram>
...
<AsciiDiagram>{diagrams.gridGutters}</AsciiDiagram>
...
<AsciiDiagramContainer justifyContent="center">
  <AsciiDiagram>{diagrams.gridPositioning}</AsciiDiagram>
...
<AsciiDiagramContainer
  ...
  flexWrap="wrap"
>
  <AsciiDiagram>{diagrams.aldoLg}</AsciiDiagram>
  <AsciiDiagram>{diagrams.aldoMd}</AsciiDiagram>
  <AsciiDiagram>{diagrams.aldoSm}</AsciiDiagram>
