...
![Basic card with a title](../assets/card-with-title.png)
...
![Card with other requirements such as caption and icon](../assets/cards-with-other-requirements.png)
...
![example of a basic card](../assets/card-example.png)
