...
date: 2019-04-18
preview: ../assets/design-system.png
---

<CallOut>
  This post was co-authored with{' '}
  <a to="http://www.catherinemaritan.com">Catherine Maritan</a> and originally
  published on the{' '}
  <a to="https://rangle.io/blog/what-is-a-design-system">Rangle.io Blog</a>.
</CallOut>
...
![A lot of chaos is introduced when changes are made during the design & development process](../assets/catherine-process-image.png)
...
![A design system includes design language, design kit, component library, developer sandbox and a documentation site](../assets/design-system.svg)
