...
![bouncy orange blob](../assets/orange.gif)
...
![springy wavy-box](../assets/springywavybox.gif)

![springy triangles](../assets/springytriangles.gif)

![many polygons](../assets/manypolygons.gif)
