...
<Embed
  mb={4}
  src="https://codesandbox.io/embed/2vv327jqjp?hidenavigation=1&module=%2Fsrc%2Ftheme.js"
...
This is honestly my favourite way to build UI components right now <img src="../assets/parrot.gif" alt="party parrot" style="display:inline !important; width: 1em !important;" />
...
<p style="margin-bottom: -2rem;">
  <a href="https://codesandbox.io/s/v86m4zkyy0" class="dib" style="border: 0;">
    <img
      alt="Edit Design System Demo — Profile Card"
      style="width: 12rem;"
      src="https://codesandbox.io/static../assets/play-codesandbox.svg"
    />
  </a>
</p>
...
<Embed
  mb={4}
  src="https://codesandbox.io/embed/myoj1yzwmx?hidenavigation=1&module=%2Fsrc%2Fdesign-system%2FInputWithAdornment.js"
...
<figure class="mh0 flex flex-wrap items-center justify-between">
  <img src="../assets/product-card-1.png" class="product-card-img" />
  <img src="../assets/product-card-2.png" class="product-card-img" />
  <img src="../assets/product-card-3.png" class="product-card-img" />
  <img src="../assets/product-card-4.png" class="product-card-img" />
  <img src="../assets/product-card-5.png" class="product-card-img" />
  <img src="../assets/product-card-6.png" class="product-card-img" />
...
<Embed
  mb={4}
  src="https://codesandbox.io/embed/woy5w424zl??view=split&hidenavigation=1&module=%2Fsrc%2FProductCard%2FProductCard.js"
  style="width:100%; height:500px; border:0; overflow:hidden;"
  sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"
/>
